...
// hold a stale build.
const CACHE_NAME = 'dlog-2026-09-02-1435';
const APP_SHELL = [
  './',
  './index.html',
  './css/style.css',
...
// ── NO PUSH, NO NOTIFICATIONS ───────────────────────────────────────────────────────────────────
// This worker has no push or notificationclick handler and asks for no notification permission.
// The rest timer in the logger is a plain stopwatch; the green ring is its only cue.
